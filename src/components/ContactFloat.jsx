  ...
  return (
    <div className="contact-float" aria-label="Quick contact">
      ...
      <div className="contact-float__desktop">
        ...
        >
          <MessageCircle className="contact-float__pill-icon" strokeWidth={2} aria-hidden />
          <span>WhatsApp</span>
        </a>
      </div>
      ...
      <div className="contact-float__mobile">
        <a
          href={waHref}
          className="contact-float__fab contact-float__fab--wa"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Chat on WhatsApp"
        >
          <svg className="contact-float__wa-svg" viewBox="0 0 24 24" aria-hidden focusable="false">
            <path
              fill="currentColor"
        ...
        <a href={telHref} className="contact-float__fab contact-float__fab--call" aria-label="Call now">
          <Phone strokeWidth={2.25} aria-hidden />
        </a>
      </div>
    </div>
  )
