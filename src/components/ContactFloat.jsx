...
function WhatsAppBrandIcon() {
  return (
    <svg className="contact-float__wa-icon" viewBox="0 0 24 24" aria-hidden focusable="false">
...
export function ContactFloat() {
  ...
  return (
    <aside className="contact-float" aria-label="Quick contact">
      <div className="contact-float__panel">
        <button
          type="button"
        ...
        <a
          href={waHref}
          className="contact-float__action contact-float__action--wa"
          target="_blank"
